<div class="bg-white-200 py-4 px-6 mb-20 items-center justify-between tab-text " id="tab2Text">
    <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between">
        <div class="lg:w-1/2 lg:mr-4 order-2 lg:order-1 mt-10 lg:mt-0">
            <h1 class="text-7xl font-bold text-black mb-4">Sponsor a child.</h1>
        ...
        <div class="lg:w-1/2 mt-10 lg:mt-0 order-1 flex items-center justify-center h-1/2">
            <!-- Image with object-cover to cover the same height as text -->
            <img src="{{ asset('images/banners/child.jpg') }}" alt="Banner Image"
                class="h-10 lg:h-1/2 w-full lg:w-auto object-cover">
        </div>
    </div>
</div>
